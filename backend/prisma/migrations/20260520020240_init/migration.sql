-- CreateEnum
CREATE TYPE "EstadoAsistencia" AS ENUM ('Programada', 'Asistió', 'Faltó', 'Cancelada');
...
CREATE TABLE "MULTAS" (
    ...
    "estudiante_id" INTEGER NOT NULL,
    "monto" DECIMAL(8,2) NOT NULL DEFAULT 10,
...
-- CreateIndex
CREATE UNIQUE INDEX "INSCRIPCIONES_estudiante_id_sesion_id_key" ON "INSCRIPCIONES"("estudiante_id", "sesion_id");
